...
const projectsData: Project[] = [
    ...
    },
    {
        ...
        keyFeatures: "Microservices architecture, Service discovery and load balancing, Distributed messaging with RabbitMQ, Asynchronous task processing, Centralized logging and monitoring, API gateway for unified access",
    ...
    },
    {
        ...
        keyFeatures: "User registration and login, Role-based access control, Token-based authentication, OAuth 2.0 authorization server, Single sign-on with Keycloak, Secure password hashing",
    ...
    },
    {
        ...
        keyFeatures: "Event-driven architecture, Real-time data processing, Stream processing with Apache Kafka, Data indexing and search with Elasticsearch, Dashboard visualization with Grafana, Scalable and fault-tolerant design",
